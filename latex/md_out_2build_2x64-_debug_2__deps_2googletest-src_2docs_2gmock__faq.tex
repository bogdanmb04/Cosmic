...
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq}{}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq}\index{Legacy gMock FAQ@{Legacy gMock FAQ}}
\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md679}%
\Hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md679}%
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md680}{}\doxysubsection{\texorpdfstring{When I call a method on my mock object, the method for the real object is invoked instead. What\textquotesingle{}s the problem?}{When I call a method on my mock object, the method for the real object is invoked instead. What\textquotesingle{}s the problem?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md680}
In order for a method to be mocked, it must be {\itshape virtual}, unless you use the \href{gmock_cook_book.md\#MockingNonVirtualMethods}{\texttt{high-\/perf dependency injection technique}}.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md681}{}\doxysubsection{\texorpdfstring{Can I mock a variadic function?}{Can I mock a variadic function?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md681}
...
Ellipsis arguments are inherited from C and not really a C++ feature. They are unsafe to use and don\textquotesingle{}t work with arguments that have constructors or destructors. Therefore we recommend to avoid them in C++ as much as possible.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md682}{}\doxysubsection{\texorpdfstring{MSVC gives me warning C4301 or C4373 when I define a mock method with a const parameter. Why?}{MSVC gives me warning C4301 or C4373 when I define a mock method with a const parameter. Why?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md682}
...
\end{DoxyCode}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md683}{}\doxysubsection{\texorpdfstring{I can\textquotesingle{}t figure out why g\+Mock thinks my expectations are not satisfied. What should I do?}{I can\textquotesingle{}t figure out why g\+Mock thinks my expectations are not satisfied. What should I do?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md683}
...
If you see the message "{}\+The mock function has no default action set, and its return type has no default value set."{}, then try \href{gmock_cheat_sheet.md\#OnCall}{\texttt{adding a default action}}. Due to a known issue, unexpected calls on mocks without default actions don\textquotesingle{}t print out a detailed comparison between the actual arguments and the expected arguments.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md684}{}\doxysubsection{\texorpdfstring{My program crashed and {\ttfamily Scoped\+Mock\+Log} spit out tons of messages. Is it a g\+Mock bug?}{My program crashed and {\ttfamily Scoped\+Mock\+Log} spit out tons of messages. Is it a g\+Mock bug?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md684}
...
\end{DoxyCode}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md685}{}\doxysubsection{\texorpdfstring{How can I assert that a function is NEVER called?}{How can I assert that a function is NEVER called?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md685}
...
\end{DoxyCode}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md686}{}\doxysubsection{\texorpdfstring{I have a failed test where g\+Mock tells me TWICE that a particular expectation is not satisfied. Isn\textquotesingle{}t this redundant?}{I have a failed test where g\+Mock tells me TWICE that a particular expectation is not satisfied. Isn\textquotesingle{}t this redundant?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md686}
...
Also, you can control the verbosity by specifying {\ttfamily -\/-\/gmock\+\_\+verbose=error}. Other values are {\ttfamily info} and {\ttfamily warning}. If you find the output too noisy when debugging, just choose a less verbose level.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md690}{}\doxysubsection{\texorpdfstring{How can I delete the mock function\textquotesingle{}s argument in an action?}{How can I delete the mock function\textquotesingle{}s argument in an action?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md690}
...
\end{DoxyCode}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md691}{}\doxysubsection{\texorpdfstring{How can I perform an arbitrary action on a mock function\textquotesingle{}s argument?}{How can I perform an arbitrary action on a mock function\textquotesingle{}s argument?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md691}
If you find yourself needing to perform some action that\textquotesingle{}s not supported by g\+Mock directly, remember that you can define your own actions using \doxysectlink{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMonoActions}{\`{}\+Make\+Action()\`{}}{2} or \doxysectlink{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewPolyActions}{\`{}\+Make\+Polymorphic\+Action()\`{}}{2}, or you can write a stub function and invoke it using \doxysectlink{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__cook__book_FunctionsAsActions}{\`{}\+Invoke()\`{}}{2}.
...
\end{DoxyCode}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md692}{}\doxysubsection{\texorpdfstring{My code calls a static/global function. Can I mock it?}{My code calls a static/global function. Can I mock it?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md692}
...
This Google Testing Blog \href{https://testing.googleblog.com/2008/06/defeat-static-cling.html}{\texttt{post}} says it excellently. Check it out.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md693}{}\doxysubsection{\texorpdfstring{My mock object needs to do complex stuff. It\textquotesingle{}s a lot of pain to specify the actions. g\+Mock sucks!}{My mock object needs to do complex stuff. It\textquotesingle{}s a lot of pain to specify the actions. g\+Mock sucks!}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md693}
...
See this \href{gmock_cook_book.md\#mocking-side-effects}{\texttt{recipe}} for more details and an example.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md697}{}\doxysubsection{\texorpdfstring{I have a huge mock class, and Microsoft Visual C++ runs out of memory when compiling it. What can I do?}{I have a huge mock class, and Microsoft Visual C++ runs out of memory when compiling it. What can I do?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md697}
