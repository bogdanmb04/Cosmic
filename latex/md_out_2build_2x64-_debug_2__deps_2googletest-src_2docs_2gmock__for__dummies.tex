...
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies}{}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies}\index{gMock for Dummies@{gMock for Dummies}}
\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md698}%
\Hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md698}%
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md699}{}\doxysection{\texorpdfstring{What Is g\+Mock?}{What Is g\+Mock?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md699}
...
\end{DoxyEnumerate}\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md700}{}\doxysection{\texorpdfstring{Why g\+Mock?}{Why g\+Mock?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md700}
...
\end{DoxyItemize}\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md701}{}\doxysection{\texorpdfstring{Getting Started}{Getting Started}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md701}
g\+Mock is bundled with googletest.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md702}{}\doxysection{\texorpdfstring{A Case for Mock Turtles}{A Case for Mock Turtles}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md702}
...
You don\textquotesingle{}t need to define these mock methods somewhere else -\/ the {\ttfamily MOCK\+\_\+\+METHOD} macro will generate the definitions for you. It\textquotesingle{}s that simple!\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md705}{}\doxysubsection{\texorpdfstring{Where to Put It}{Where to Put It}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md705}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using g\+Mock. However, as we shall reveal soon, g\+Mock allows you to do {\itshape so much more} with the mocks.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md707}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md707}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. g\+Mock provides the necessary means for you to do it "{}just right."{}\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md708}{}\doxysubsection{\texorpdfstring{General Syntax}{General Syntax}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md708}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} Why do we use a macro to do this? Well it serves two purposes\+: first it makes expectations easily identifiable (either by {\ttfamily grep} or by a human reader), and second it allows g\+Mock to include the source file location of a failed expectation in messages, making debugging easier.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md709}{}\doxysubsection{\texorpdfstring{Matchers\+: What Arguments Do We Expect?}{Matchers\+: What Arguments Do We Expect?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md709}
...
In the above examples, {\ttfamily 100} and {\ttfamily 50} are also matchers; implicitly, they are the same as {\ttfamily Eq(100)} and {\ttfamily Eq(50)}, which specify that the argument must be equal (using {\ttfamily operator==}) to the matcher argument. There are many \doxysectlink{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers}{built-\/in matchers}{0} for common types (as well as \href{gmock_cook_book.md\#NewMatchers}{\texttt{custom matchers}}); for example\+:
...
This works for all non-\/overloaded methods; if a method is overloaded, you need to help g\+Mock resolve which overload is expected by specifying the number of arguments and possibly also the \href{gmock_cook_book.md\#SelectOverload}{\texttt{types of the arguments}}.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md710}{}\doxysubsection{\texorpdfstring{Cardinalities\+: How Many Times Will It Be Called?}{Cardinalities\+: How Many Times Will It Be Called?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md710}
...
{\bfseries{Quick quiz\+:}} what do you think will happen if a function is expected to be called twice but actually called four times?\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md711}{}\doxysubsection{\texorpdfstring{Actions\+: What Should It Do?}{Actions\+: What Should It Do?}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md711}
...
Instead of returning 100, 101, 102, ..., consecutively, this mock function will always return 100 as {\ttfamily n++} is only evaluated once. Similarly, {\ttfamily Return(new Foo)} will create a new {\ttfamily Foo} object when the {\ttfamily EXPECT\+\_\+\+CALL()} is executed, and will return the same pointer every time. If you want the side effect to happen every time, you need to define a custom action, which we\textquotesingle{}ll teach in the \doxysectlink{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__cook__book}{cook book}{0}.
...
Obviously {\ttfamily turtle.\+Get\+Y()} is expected to be called four times. But if you think it will return 100 every time, think twice! Remember that one {\ttfamily Will\+Once()} clause will be consumed each time the function is invoked and the default action will be taken afterwards. So the right answer is that {\ttfamily turtle.\+Get\+Y()} will return 100 the first time, but {\bfseries{return 0 from the second time on}}, as returning 0 is the default action for {\ttfamily int} functions.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_MultiExpectations}{}\doxysubsection{\texorpdfstring{Using Multiple Expectations}{Using Multiple Expectations}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_MultiExpectations}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! The details can be found \href{gmock_cook_book.md\#OrderedCalls}{\texttt{here}}.)\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_StickyExpectations}{}\doxysubsection{\texorpdfstring{All Expectations Are Sticky (Unless Said Otherwise)}{All Expectations Are Sticky (Unless Said Otherwise)}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_StickyExpectations}
...
Suppose {\ttfamily turtle.\+Go\+To(0, 0)} is called three times. In the third time, g\+Mock will see that the arguments match expectation \#2 (remember that we always pick the last matching expectation). Now, since we said that there should be only two such calls, g\+Mock will report an error immediately. This is basically what we\textquotesingle{}ve told you in the \doxysectlink{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_MultiExpectations}{Using Multiple Expectations}{2} section above.
