...
\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md393}{}\doxysubsection{\texorpdfstring{Generic Build Instructions}{Generic Build Instructions}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md393}
\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md394}{}\doxysubsubsubsection{\texorpdfstring{Setup}{Setup}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md394}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md395}{}\doxysubsubsection{\texorpdfstring{Build with CMake}{Build with CMake}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md395}
...
CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md396}{}\doxysubsubsubsection{\texorpdfstring{Standalone CMake Project}{Standalone CMake Project}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md396}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md397}{}\doxysubsubsubsection{\texorpdfstring{Incorporating Into An Existing CMake Project}{Incorporating Into An Existing CMake Project}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md397}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md398}{}\doxysubsubsubsubsection{\texorpdfstring{Visual Studio Dynamic vs Static Runtimes}{Visual Studio Dynamic vs Static Runtimes}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md398}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md399}{}\doxysubsubsubsection{\texorpdfstring{C++ Standard Version}{C++ Standard Version}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md399}
An environment that supports C++11 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 11)} command. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the {\ttfamily DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md400}{}\doxysubsubsection{\texorpdfstring{Tweaking Google\+Test}{Tweaking Google\+Test}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md400}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md401}{}\doxysubsubsection{\texorpdfstring{Multi-\/threaded Tests}{Multi-\/threaded Tests}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md401}
...
Note\+: while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. GCC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{https://gcc.gnu.org/wiki/Visibility}{\texttt{https\+://gcc.\+gnu.\+org/wiki/\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google\+Test as a shared library. Otherwise a future release of Google\+Test may break your build script.\hypertarget{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md403}{}\doxysubsubsection{\texorpdfstring{Avoiding Macro Name Clashes}{Avoiding Macro Name Clashes}}\label{dir_001a0f336d1d0a6c17b1be78e41a6b36_autotoc_md403}
