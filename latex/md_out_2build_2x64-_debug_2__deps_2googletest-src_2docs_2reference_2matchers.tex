...
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers}{}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers}\index{Matchers Reference@{Matchers Reference}}
\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md750}%
\Hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md750}%
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md751}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md751}
...
\end{DoxyTable}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md752}{}\doxysection{\texorpdfstring{Generic Comparison}{Generic Comparison}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md752}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{{\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_FpMatchers}{}\doxysection{\texorpdfstring{Floating-\/\+Point Matchers}{Floating-\/\+Point Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_FpMatchers}
...
\end{DoxyTable}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md753}{}\doxysection{\texorpdfstring{String Matchers}{String Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md753}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md754}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md754}
...
\item an array passed as a pointer and a count (e.\+g. in {\ttfamily Bar(const T\texorpdfstring{$\ast$}{*} buffer,         int len)} -- see \doxysectlink{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_MultiArgMatchers}{Multi-\/argument Matchers}{1}).
\end{DoxyEnumerate}
...
\end{DoxyItemize}\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md755}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md755}
...
\end{DoxyItemize}\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md756}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md756}
...
\end{DoxyTable}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md757}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md757}
...
\end{DoxyTable}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_MultiArgMatchers}{}\doxysection{\texorpdfstring{Multi-\/argument Matchers}{Multi-\/argument Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_MultiArgMatchers}
...
\end{DoxyTable}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md758}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md758}
...
\end{DoxyTable}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md759}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md759}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_MatchersAsPredicatesCheat}{}\doxysection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_MatchersAsPredicatesCheat}
...
\end{DoxyTable}
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md760}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md760}
