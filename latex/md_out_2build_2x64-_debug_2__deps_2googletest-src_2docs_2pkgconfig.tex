...
\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig}{}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig}\index{Using GoogleTest from various build systems@{Using GoogleTest from various build systems}}
\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md715}%
\Hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md715}%
...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md716}{}\doxysubsection{\texorpdfstring{CMake}{CMake}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md716}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md718}{}\doxysubsection{\texorpdfstring{Using pkg-\/config in a cross-\/compilation setting}{Using pkg-\/config in a cross-\/compilation setting}}\label{md_out_2build_2x64-_debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md718}
